...
- **No numbered prose in docs/comments.** Never write "there are 3 ways..." or "step 1, step 2" in docs, comments, or README — those go stale the moment code changes. Proper ordered lists (1. 2. 3.) are fine. Plans are exempt — numbered steps are useful there. Use indefinite phrasing instead: "multiple ways", "several steps", or just list them without numbers.
